...
import { Zap, TrendingUp, Activity, Leaf, TriangleAlert, LayoutDashboard, BarChart3 } from 'lucide-react';
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              <KPICard
                ...
                value={mockData.kpis.currentConsumption}
                unit="kW"
                trend={-3.2}
                icon={Zap}
                color="blue"
              ...
              <KPICard
                ...
                value={(mockData.kpis.forecast24h / 1000).toFixed(1)}
                unit="MWh"
                trend={2.8}
                icon={TrendingUp}
                color="purple"

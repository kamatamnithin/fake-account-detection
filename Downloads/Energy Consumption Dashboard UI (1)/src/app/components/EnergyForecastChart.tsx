  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-slate-800 text-xl font-bold mb-1">Energy Consumption Forecast</h2>
        ...
        <div className="flex items-center gap-2">
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-4 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition-colors font-medium shadow-lg shadow-blue-500/30"
          >
            24 Hours
          </motion.button>
          <motion.button
